...
(α - 1)/(τ - 1) = γ_avalanche
α ≈ 2.0, τ ≈ 1.5, γ ≈ 1.3
Check: (2.0-1)/(1.5-1) = 2.0 ≟ 1.3 (NO - requires recalibration)
```

Corrected for TRIAD-0.83:
```
...
```
4 × 0.630 = 2.52 ≟ 2 - 0.110 = 1.89
```

Close but imperfect - suggests effective dimensionality may be d_eff ≈ 3.0, not 4.0.
